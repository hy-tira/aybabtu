...
Algoritmi muodostuu $$n-1$$ kierroksesta, missä $$n$$ on verkon solmujen määrä. Jokaisella kierroksella algoritmi käy läpi kaikki verkon kaaret ja koettaa pienentää etäisyyksiä kaarten avulla. Kun kaari on solmusta $$a$$ solmuun $$b$$, algoritmi tarkastaa, saadaanko kaaren avulla pienempi etäisyys solmun $$a$$ kautta solmuun $$b$$. Jos etäisyys on pienempi, algoritmi merkitsee muistiin uuden etäisyyden.
