...
Kun algoritmi toteutetaan ohjelmointikielellä, se voidaan suorittaa tietokoneella.
...
Python-kielen perustietorakenne on lista, jonka lisäksi kielessä on muitakin valmiita tietorakenteita. Algoritmin tehokkuuteen voi vaikuttaa merkittävästi, mitä tietorakenteita siinä käytetään.

TODO: video?

Tällä kurssilla perehdymme siihen, mihin Pythonin tietorakenteiden
...
Funktion voisi toteuttaa melko samalla tavalla esimerkiksi JavaScriptilla:
...
Jälkimmäisen funktion etuna on, että se on tiiviimpi ja sen voi ajatella olevan
enemmän Python-kielen tyylin mukainen. Vaikka ohjelmoinnin perusasiat riittävät kaikkeen, voi olla kiinnostavaa oppia myös kielten erikoisominaisuuksia.
...
Algoritmien tehokkuutta voidaan tutkia testiohjelmalla,
...
Algoritmit 2 ja 3 ovat sen sijaan tehokkaita myös suurilla syötteillä. Viimeinen testi tuo näkyviin eron myös algoritmin 2 ja 3 välille, vaikkakaan ero ei ole niin suuri kuin verrattuna algoritmiin 1.
...
että muuttuja $$n$$ kuvaa syötteen kokoa.
