...
Ohjelma mittaa funktion ajankäytön funktion `time.time` avulla. Funktio palauttaa sekunteina kuluneen ajan vuoden 1970 alusta alkaen. Kun tämä aika laitetaan talteen ennen funktion kutsua ja funktion kutsun jälkeen, aikojen erotus kertoo, kauanko funktion suoritus vei aikaa. Aika pyöristetään kahden desimaalin tarkkuudelle funktiolla `round`.
